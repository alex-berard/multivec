...
public:
    ...
    float similaritySentenceSyntax(const string& src_seq, const string& trg_seq, const string& src_tags, const string& trg_tags, const string& src_idf, const string& trg_idf, float alpha = 0.0, int policy = 0) const; // similarity between two variable-size sequences according of part-of-speech and inverse document frequencies of terms in the sequences
