...
./benchmarks/cldc-evaluate-bivec-model.sh $output_dir/bivec-model.128.en-de.bin $rcv_dir > $output_dir/bivec-model.128.en-de.out
...
./benchmarks/cldc-evaluate-bivec-model.sh $output_dir/bivec-model.40.en-de.bin $rcv_dir > $output_dir/bivec-model.40.en-de.out
