...
#bin/word2vec --train ${data_dir}/alldata-id.shuf.txt --save-vectors ${output_dir}/vectors.txt --sg --dimension 100 --window-size 10 --negative 5 --hs 1 --subsampling 1e-3 --iter 20 --min-count 1 --sent-vector
